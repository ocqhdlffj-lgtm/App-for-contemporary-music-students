...
T.test('formatDates: 날짜가 3개 이상이고 서로 연속하지 않으면 콤마로 나열한다', function () {
  T.eq(PM.ui.formatDates(['2026-10-08', '2026-10-15', '2026-12-04']),
    '2026-10-08, 2026-10-15, 2026-12-04');
});

T.test('formatDates: 연속된 날짜는 묶어서 기간으로, 묶음 사이는 콤마로 구분한다', function () {
  T.eq(PM.ui.formatDates([
    '2026-10-12', '2026-10-13', '2026-10-14', '2026-10-15',
    '2026-10-16', '2026-10-17', '2026-10-18',
    '2026-10-24', '2026-10-25'
  ]), '2026-10-12 ~ 2026-10-18, 2026-10-24 ~ 2026-10-25');
});
